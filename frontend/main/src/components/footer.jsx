            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-gray-400">Лучший магазин электроники с 2023 года</p>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-4">Контакты</h3>
                        <p className="text-gray-400">Email: info@techshop.com</p>
                        <p className="text-gray-400">Телефон: +1 (123) 456-7890</p>
                    </div>
                    <div>
